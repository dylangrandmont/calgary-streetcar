...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$2, 23, 4, 459);
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$2, 17, 8, 288);
    			add_location(div0, file$2, 15, 4, 253);
    			add_location(hr, file$2, 19, 4, 377);
    			attr_dev(div1, "class", "root svelte-11yf73c");
    			add_location(div1, file$2, 14, 0, 230);
    		},
    ...
    class Controls extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { speed: 0, selectedId: 1 });
    ...
    const file$1 = "src/SelectedLine.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			div0 = element("div");
    			attr_dev(div0, "class", "line svelte-o5784q");
    			attr_dev(div0, "style", `background-color: ${/*selectedRoute*/ ctx[0].color}`);
    			add_location(div0, file$1, 23, 4, 417);
    			attr_dev(div1, "class", "root svelte-o5784q");
    			add_location(div1, file$1, 21, 0, 369);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class SelectedLine extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { selectedId: 1 });
    ...
    function create_fragment(ctx) {
    	...
    	let if_block = /*selectedId*/ ctx[0] && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 137, 0, 3645);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
