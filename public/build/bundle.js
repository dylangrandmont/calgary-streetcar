...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*selectedId*/ ctx[1]) return create_if_block;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file, 23, 8, 430);
    			add_location(div0, file, 21, 4, 395);
    			add_location(hr, file, 25, 4, 519);
    			attr_dev(div1, "class", "root svelte-1klgeya");
    			add_location(div1, file, 20, 0, 372);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ routes, speed, selectedId });
    ...
    function create_fragment(ctx) {
    	...
    	function sidepanel_speed_binding(value) {
    		/*sidepanel_speed_binding*/ ctx[4](value);
    	}

    	let sidepanel_props = { selectedId: /*selectedId*/ ctx[0] };

    	if (/*speed*/ ctx[1] !== void 0) {
    		sidepanel_props.speed = /*speed*/ ctx[1];
    	}
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*selectedId*/ 1) sidepanel_changes.selectedId = /*selectedId*/ ctx[0];

    			if (!updating_speed && dirty & /*speed*/ 2) {
    				updating_speed = true;
    				sidepanel_changes.speed = /*speed*/ ctx[1];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	return [selectedId, speed, trackIndex, shouldTrackCamera, sidepanel_speed_binding];
    }
