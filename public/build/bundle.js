...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file, 15, 4, 222);
    			attr_dev(div, "class", "root svelte-ut23ai");
    			add_location(div, file, 13, 0, 182);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	return [speed, input_change_input_handler];
    }

    class SidePanel extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { speed: 0 });
    ...
    function create_fragment(ctx) {
    	...
    	function sidepanel_speed_binding(value) {
    		/*sidepanel_speed_binding*/ ctx[1](value);
    	}
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	return [speed, sidepanel_speed_binding];
    }
